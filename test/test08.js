...
async function testTourSteps() {
    ...
    try {
        ...
        await driver.wait(until.elementLocated(By.id("email")), 10000).sendKeys("tester@gg.cc");
        ...
        await driver.wait(until.elementLocated( By.xpath("//*[contains(., 'Are you ready to go on a challenge & consensus tour?')]")), 15000);
